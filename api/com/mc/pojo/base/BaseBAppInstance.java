...
/**
 * This is an object that contains data related to the b_app_instance table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="b_app_instance"
 */

public abstract class BaseBAppInstance  implements Serializable {

	public static String REF = "BAppInstance";
	public static String PROP_NAME = "Name";
	public static String PROP_IP = "Ip";
	public static String PROP_PORT = "Port";
	public static String PROP_DESCRIPTION = "Description";
	public static String PROP_SC = "Sc";
	 ...
	 */
	public BaseBAppInstance (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	// many to one
	private com.mc.pojo.BAppCluster sc;
	 ...
	 */
	public com.mc.pojo.BAppCluster getSc () {
		return sc;
	}

	/**
	 * Set the value related to the column: sc_id
	 * @param sc the sc_id value
	 */
	public void setSc (com.mc.pojo.BAppCluster sc) {
		this.sc = sc;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mc.pojo.BAppInstance)) return false;
		else {
			com.mc.pojo.BAppInstance bAppInstance = (com.mc.pojo.BAppInstance) obj;
			if (null == this.getId() || null == bAppInstance.getId()) return false;
			else return (this.getId().equals(bAppInstance.getId()));
		}
	}
